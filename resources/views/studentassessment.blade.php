...
<style>
    ...
    <h5>
    <a href="/studentdashboard" class="w3-bar-item w3-button " id="homeLink">
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-house-check-fill" viewBox="0 0 16 16">
        ...
        <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m1.679-4.493-1.335 2.226a.75.75 0 0 1-1.174.144l-.774-.773a.5.5 0 0 1 .708-.707l.547.547 1.17-1.951a.5.5 0 1 1 .858.514" />
            ...
            <a href="/studentclassload" class="w3-bar-item w3-button" id="classLoadLink">
            ...
            <a href="studentassessment" class="w3-bar-item w3-button active">
...
<div id="main" onclick="w3_close()">
    ...
    <div class="test" style="min-height: 80vh;">
        <div class="form-container">
            <h2 class="text-center">View Assessment</h2>
